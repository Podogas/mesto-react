...
function Card(props) {
  ...
  return (
    <article className="element">
      {isOwn? <button className="element__trash-can" type="button" onClick={handleCardDeletion}></button> : null}
      ...
      <div className="element__like-wrapper">
        <button className={`element__like-button ${isLiked? 'element__like-button_liked': ''}`} type="button" onClick={handleLikeClick}></button>
